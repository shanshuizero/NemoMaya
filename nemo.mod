+ MAYAVERSION:2019 PLATFORM:win64 Nemo 1 ./
...
+ MAYAVERSION:2023 PLATFORM:win64 Nemo 1 ./
plug-ins: plug-ins/windows-2023
scripts: ./
MAYA_CUSTOM_TEMPLATE_PATH+:= ui_templates
NEMO_MODULES:= modules
PYTHONPATH+:= lib/windows-2023
PYTHONPATH+:= extern

+ MAYAVERSION:2019 PLATFORM:linux Nemo 1 ./
